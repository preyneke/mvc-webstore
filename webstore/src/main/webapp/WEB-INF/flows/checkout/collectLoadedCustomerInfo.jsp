      ...
      <form:form modelAttribute="order.customer" class="form-horizontal">
         <fieldset>
            ...
            <div class="form-group">
               ...
               <div class="col-lg-10">
                  <form:input id="name" path="name" type="text" value="${order.customer.name}" class="form:input-large" />
               </div>
            </div>
            <div class="form-group">
               <label class="control-label col-lg-2" for="doorNo">Door No</label>
               <div class="col-lg-10">
                  <form:input id="doorNo" path="billingAddress.doorNo" type="text" value="${order.customer.billingAddress.doorNo}"
