...
ID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 101, INCREMENT BY 1) PRIMARY KEY,
DOOR_NO VARCHAR(25),
...
ID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 201, INCREMENT BY 1) PRIMARY KEY,
NAME VARCHAR(25),
